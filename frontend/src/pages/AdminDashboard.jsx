...
const features = [
  { title: "Analytics Overview", icon: <ChartBarIcon style={{width:32,height:32,color:'#2563eb'}} />, component: <AnalyticsDashboard /> },
  { title: "Staff Access Management", icon: <KeyIcon style={{width:32,height:32,color:'#10b981'}} />, component: <AdminAccess /> },
  { title: "Live Location Tracking", icon: <MapIcon style={{width:32,height:32,color:'#f59e42'}} />, component: <StaffLocation /> },
  { title: "Staff Check-In", icon: <CheckCircleIcon style={{width:32,height:32,color:'#10b981'}} />, component: <StaffCheckin /> },
  { title: "Staff Scan", icon: <QrCodeIcon style={{width:32,height:32,color:'#2563eb'}} />, component: <StaffScan /> },
  ...
  <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #1e3c72 0%, #2a5298 100%)", display: "flex", flexDirection: "row-reverse", fontFamily: "Segoe UI, sans-serif" }}>
    ...
    <div style={{ flex: 1, marginRight: 280, padding: 40 }}>
      <div style={{ display: "flex", alignItems: "center", marginBottom: 24, animation: 'fadeInDown 0.8s' }}>
        ...
        <h1 style={{ fontWeight: 700, fontSize: 36, color: "#fff", letterSpacing: 1, textShadow: '0 2px 8px #1e3c72' }}>MMadTrack360 Admin Dashboard</h1>
      </div>
