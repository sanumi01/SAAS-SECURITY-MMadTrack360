  ...
  return (
    <div className='min-h-screen p-6 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100'>
      <div className='max-w-4xl mx-auto'>
        ...
        <p className='mb-6 text-slate-600 dark:text-slate-300'>Update your account details, profile information and contact preferences.</p>
        ...
        <section className='bg-white dark:bg-slate-800 p-6 rounded shadow-sm'>
          ...
          <div className='space-y-3'>
            <div className='flex flex-col sm:flex-row sm:items-center gap-2'>
              <label className='w-28 text-sm text-slate-600 dark:text-slate-300'>Full name</label>
              <div className='flex-1'>John Admin</div>
            </div>
            <div className='flex flex-col sm:flex-row sm:items-center gap-2'>
              <label className='w-28 text-sm text-slate-600 dark:text-slate-300'>Email</label>
