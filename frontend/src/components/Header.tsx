    ...
    <header className='bg-transparent px-6 py-4 z-40'>
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-4'>
          <Button variant='ghost' size='icon' onClick={() => setSidebarOpen(!sidebarOpen)} className='hover:bg-white/5' aria-label='Toggle sidebar'>
        ...
        <div className='flex items-center gap-3'>
          <Button variant='ghost' size='icon' className='relative hover:bg-white/5' onClick={() => navigate('/admin/notifications')} aria-label='Notifications'>
          ...
          <Button variant='ghost' size='icon' onClick={toggleTheme} className='hover:bg-white/5' aria-label='Toggle theme'>
          ...
          <div className='relative'>
            <button className='flex items-center gap-2 pl-3 border-l border-white/10 pr-2 py-1 hover:bg-white/5 rounded text-white' aria-haspopup='true' aria-label='User menu'>
